...
@Script.Manifest(name = "FN Headless-Arrows", description = "Fletches headless arrows or picks up feathers.", properties = "topic=1253323;client=6;vip=false;hidden=false;")
